...
export function GeneratorTab({ initialUrl }: GeneratorTabProps) {
        ...
        <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 space-y-6 shadow-sm animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-4 border-b border-slate-100">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              {/* How to Paste Code Button */}
              <button
                type="button"
                onClick={() => setIsGuideOpen(true)}
                className="px-4 py-2 bg-teal-50 hover:bg-teal-100 text-teal-800 border border-teal-200 rounded-xl text-xs font-bold flex items-center gap-1.5 transition-colors"
              >
                <HelpCircle className="w-4 h-4 text-teal-600" />
                How to Paste Code Guide
              </button>
